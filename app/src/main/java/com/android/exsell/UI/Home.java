...
public class Home extends AppCompatActivity {
    ...
    // categories
    LinearLayout ll;
    int[] categoryImages = {R.drawable.ic_category_more,R.drawable.ic_category_textbooks, R.drawable.ic_category_clothes, R.drawable.ic_category_furniture, R.drawable.ic_category_electronics, R.drawable.ic_category_sports, R.drawable.ic_category_more};
